                                        ...
                                        <?php foreach ($project_tasks as $index => $task): ?>
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td><input type="text" name="start_date[]"  class="form-control task-start-date datepicker" readonly  value="<?= htmlspecialchars($task['start_date']) ?>"></td>
                                                  <td><input type="text" name="end_date[]" class="form-control task-end-date datepicker" readonly value="<?= htmlspecialchars($task['end_date']) ?>"></td>
                                                <td>
